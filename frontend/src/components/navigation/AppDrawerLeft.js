  ...
  const navLinks = [
    {
      text: 'Home',
      link: '/',
      icon: <HomeOutlinedIcon className={classes.iconColor} />,
    },
    {
      text: 'My friends',
      link: '/friends',
      icon: <PeopleOutlinedIcon className={classes.iconColor} />,
    },
    {
      text: 'My Booster',
      link: '/list',
      icon: <MoodIcon className={classes.iconColor} />,
    },
    {
      text: 'Add Booster',
      link: '/add',
    ...
    },
    {
      text: 'Logout',
      link: '/logout',
      icon: <PowerSettingsNewOutlinedIcon style={{ color: '#951010' }} />,
    },
  ];
  const list = (anchor) => (
    <div
