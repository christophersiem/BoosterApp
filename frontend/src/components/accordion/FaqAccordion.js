...
export default function FaqAccordion() {
  ...
  const faqQuestions = [
    ...
    },
    {
      ...
      answer:
        'Simply go to the friends page, enter the username of your friend and add him/her to your friendlist. You now have the option to create a booster for your friend.',
    },
    {
      question: 'What kind of Booster can I create?',
      answer:
        'You have the option to create a booster with a personal message and/or send a picture or share a youtube video',
    },
    {
      question: "How can I delete a booster that I've created?",
      answer:
        "Go to the My Booster section and delete the booster of your choice. Caution: if the booster was made for a friend, he/she won't be able to see this booster anymore.",
    },
  ];
