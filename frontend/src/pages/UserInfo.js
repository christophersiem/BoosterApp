...
export default function UserInfo() {
  ...
  const userDetails = [
    ...
    {
      no: '4',
      heading: 'Total created booster ',
      content: userNumbers.createdBooster,
    },
    {
      no: '5',
      heading: 'Number of friends',
      content: userNumbers && userNumbers.friends.length,
    },
  ];
