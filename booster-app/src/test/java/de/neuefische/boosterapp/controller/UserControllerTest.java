...
class UserControllerTest {
    ...
    public void addUserShouldAddUserToDb(){
        ...
        BoosterUser registerUser = new BoosterUser("","chris2020",encoder.encode("!!21*QqwW"),"Markus","test@test.de","user");
        userDb.save(registerUser);

        //WHEN
        String url = "http://localhost:"+ port + "/auth/register";
        ResponseEntity<String> postResponse = restTemplate.postForEntity(url, new BoosterUser("","chris2020",encoder.encode("!!21*QqwW"),"Markus","test@test.de",""),String.class);
