    ...
    <Router>
      <div className="App">
        ...
        <Switch>
          ...
          <PrivateRoute path="/list" component={ListBooster} exact />
          <PrivateRoute path="/add" component={AddBooster} exact />
          <PrivateRoute path="/friends" component={Friends} exact />
          <PrivateRoute path="/" component={Main} exact />
          <PrivateRoute path="/faq" component={FAQ} exact />
          <PrivateRoute path="/booster/:id" component={ShowBooster} exact />
        </Switch>
        <Footer />
      </div>
    </Router>
